...
//    canvas.setAttribute("height", "500")
    ...
    fun mandelbrot(x: Int, y: Int, zoom: Int, xOffset: Double, yOffset: Double): Double {
        val a = (x.toDouble() / zoom + xOffset)
        val b = (y.toDouble() / zoom + yOffset)
        var curA = 0.0
        var curB = 0.0
